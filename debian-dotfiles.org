#+TITLE: debian dotfiles macbook pro retina
#+STARTUP: overview hideblocks
#+OPTIONS: num:nil author:nil
#+PROPERTY: header-args :mkdirp yes :noweb yes 
* dotfiles update

dotfiles for debian on a macbook pro retina

[[https://github.com/NapoleonWils0n/changelog?tab=readme-ov-file#debian-dotfiles][debian dotfiles changelog]]
...
#+begin_src sh
emacs --batch -l org --eval '(org-babel-tangle-file "~/git/debian/debian-dotfiles/debian-dotfiles.org")'
#+end_src
...
**** registries.conf tangle :tangle:
***** home dir

#+NAME: podman-registries.conf-home-dir
#+BEGIN_SRC conf :tangle "~/.config/containers/registries.conf"
...
#+BEGIN_SRC conf :tangle "~/.config/mpd/playlists/radio.m3u"
<<mpd-playlists>>
#+END_SRC
...
** user-dirs.dirs :userdirs:
*** user-dirs.dirs config :config:
...
*** weechat tangle :tangle:
**** home dir

#+NAME: weechat.conf-home-dir
#+BEGIN_SRC conf :tangle "~/.config/weechat/weechat.conf"
<<weechat.conf>>
#+END_SRC
