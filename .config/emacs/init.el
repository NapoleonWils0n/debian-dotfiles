...
(custom-set-variables
 ...
 '(package-selected-packages
   '(async consult doom-modeline doom-themes doom-modeline-now-playing
           ednc elfeed elfeed-org elfeed-tube elfeed-tube-mpv embark
           embark-consult emmet-mode evil evil-collection evil-leader
           fd-dired gptel git-auto-commit-mode hydra iedit magit marginalia
           mpv nerd-icons ob-async orderless org-tree-slide rg s
